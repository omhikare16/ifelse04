/*Write a program to check whether the given number is in the range of 1 to 1000 or
...
class Code1{
	public static void main(String[] args){
		...
		int num3=-11;
                if(num3>0 && num3<1000){
                        System.out.println(num3+ " is in the range 1 to 1000");
                }
                else{
                        System.out.println(num3+ " is not in the range 1 to 1000");
                }
	}
}
